#!/usr/bin/env python
# -*- coding: utf-8 -*-
NONE_ADMIN = "Hi {},Please get yourself registered as a teacher by @UnuaLibro."
ACTIVITY_SELECT =":sunny:Hi Teacher {}, Whom will you worship today?\n↓ Syntax ~ Apollo\n" \
                 "↓ Spelling ~ Zalmoxis\n↓ Pronunciation ~ Gaia\n" \
                 "↓ Grammar ~ Seshat\n↓ Focus - Sherlock"
COMMAND_NOT_ALLOWED ="Option not allowed in the group"
...
RULES="🔫 The Police Station will not provide any further information.\n" \
      "⚠️To join this manhunt, click the join button below.\n" \
...
ACHIEVEMENT = "🎖{} here is your {} badge! You may use it as avatar!\nCongratulations!" \
              " In order to reach the next rank you must:\n1.Post {} in the respective group\n" \
              "2.Win {} credit points in bot exercises in the respective group"